...
const columnasMovimientos = [
    ...
    { titulo: 'Libro', render: (fila) => <span className="font-semibold text-slate-800">{fila.titulo || 'Sin título'}</span> },
    ...
    },
    {
        ...
        alineacion: 'centro',
        render: (fila) => <span className="font-bold text-slate-800">{Number(fila.stock_resultante || 0)}</span>,
    },
    { titulo: 'Motivo', render: (fila) => <span className="text-xs text-slate-600">{fila.motivo || 'Sin motivo'}</span> },
