    ...
    return (
        <div className="space-y-4">
            ...
            <section className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-4">
                <StatCard titulo="Total de libros" valor={resumen.total_libros} icono={<FaBook />} />
                <StatCard titulo="Autores" valor={resumen.total_autores} icono={<FaUserPen />} />
                <StatCard titulo="Categorías" valor={resumen.total_categorias} icono={<FaTags />} />
                <StatCard titulo="Reservas" valor={resumen.total_reservas} icono={<FaCalendarCheck />} />
                <StatCard titulo="Total vendido" valor={formatearMoneda(resumen.total_vendido)} icono={<FaMoneyBillTrendUp />} />
                <StatCard titulo="Usuarios" valor={resumen.total_usuarios} icono={<FaUsers />} />
                <StatCard titulo="Stock bajo" valor={resumen.libros_stock_bajo} icono={<FaTriangleExclamation />} />
                <StatCard titulo="Ventas pagadas" valor={resumen.total_ventas} icono={<FaCircleCheck />} />
            </section>
