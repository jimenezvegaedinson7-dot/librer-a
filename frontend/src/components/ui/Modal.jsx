            ...
            {abierto && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    <motion.div
                        ...
                        role="dialog"
                        aria-modal="true"
                        className={`modal-panel relative flex max-h-[90vh] w-full flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-2xl ${
                    ...
                    >
                        <div className="modal-header flex items-center justify-between gap-3 border-b border-slate-200 px-5 py-4">
                            <div className="min-w-0">
                                <h2 className="font-sans text-base font-semibold text-slate-900">{titulo}</h2>
                        ...
                        {footer && (
                            <div className="flex items-center justify-end gap-3 border-t border-slate-200 bg-slate-50 px-5 py-3.5">
                                {footer}
                            </div>
                        )}
                    </motion.div>
