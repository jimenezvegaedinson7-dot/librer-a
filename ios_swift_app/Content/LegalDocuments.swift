...
extension LegalDocument {
    ...
    static let complaintsBookURL = URL(string: "https://librer-a-zeta.vercel.app/libro-de-reclamaciones")!
    ...
    static let terms = LegalDocument(
        ...
        sections: [
            ...
            .init(title: "2. La cuenta del cliente", text: "Para comprar o reservar necesitas crear una cuenta con datos válidos y reales. Eres responsable de mantener la confidencialidad de tu contraseña y de toda la actividad que se realice en tu cuenta. Debes notificarnos de inmediato cualquier uso no autorizado. Puedes eliminar tu cuenta cuando quieras desde Perfil → Eliminar mi cuenta."),
            ...
            .init(title: "6. Devoluciones y cambios", text: "Aceptamos devoluciones o cambios de libros en buen estado dentro de los 7 días calendario posteriores a la entrega, siempre que no presenten señales de uso y conserven su empaque original. Si el libro llegó dañado, con fallas de impresión o no corresponde a tu pedido, lo cambiamos o te devolvemos el importe por el mismo medio de pago, sin costo para ti. Las condiciones especiales de cada venta se indican al momento de la compra."),
            ...
            .init(title: "11. Contacto", text: "Por consultas sobre estos términos puedes escribirnos a través de la información de contacto publicada en la aplicación. Si no estás conforme con un producto o con nuestra atención, puedes registrar un reclamo o una queja en nuestro Libro de Reclamaciones virtual (Perfil → Libro de Reclamaciones). Te responderemos en un plazo no mayor a 15 días hábiles."),
        ]
    )
    ...
    static let privacy = LegalDocument(
        ...
        sections: [
            ...
            .init(title: "10. Contacto", text: "Por consultas sobre el tratamiento de tus datos, para ejercer tus derechos ARCO o cancelar tu cuenta, escríbenos a través de la información de contacto publicada en la aplicación. Si prefieres cancelar tu cuenta, también puedes eliminarla directamente desde Perfil → Eliminar mi cuenta."),
        ]
    )
}
